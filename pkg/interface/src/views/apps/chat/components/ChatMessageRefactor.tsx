  ...
  render() {
    ...
    return (
      <Box
        ...
        style={style}
      >
        {/* {dayBreak && !isLastRead ? <div when={msg['time-sent']} /> : null} */}
        {renderSigil ? (
          // Render the Message with an author sigil
          <>
            <MessageAuthor pb={'2px'} {...messageProps} />
            <Message pl={5} pr={3} {...messageProps} />
          </>
        ) : (
          // Render the Message without a sigil and timestamp hovering
...
export const MessagePlaceholder = () => {
  return <div>Message placeholder</div>;
};
